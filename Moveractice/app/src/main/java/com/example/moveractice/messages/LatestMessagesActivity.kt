...
import com.example.moveractice.RegisterActivity
import com.example.moveractice.Views.LatestMessageRow
...
class LatestMessagesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclervie_latest_msg.adapter = adapter
        recyclervie_latest_msg.addItemDecoration(DividerItemDecoration(this, DividerItemDecoration.VERTICAL))
